...
pub mod pallet {
	...
	/// **Note:** The code currently assumes that one descendant chain does not contain two epoch
	/// changes. If it does, signature verification will fail.
...
mod tests2 {
	...
	use sp_core::{
		sr25519::{
			vrf::{VrfPreOutput, VrfProof, VrfSignature},
			// Pair,
		},
		ByteArray, Pair, H256,
	};
